  ...
  return (
    <div className="max-w-2xl mx-auto mt-10 p-4 sm:p-6">
      <div className="bg-white shadow-lg rounded-xl p-8">
        <h2 className="text-3xl font-bold mb-6 text-gray-600">Edit Post</h2>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <textarea
            ...
            required
            className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500 h-40 resize-none"
          ></textarea>
          <button
            type="submit"
